...
// param: {array} tableau d'objet représentant les animaux, {num} identifiant habitat
function getListResident(listAnimals, id) {
    return listAnimals.filter(animal => animal.habitat === id);
